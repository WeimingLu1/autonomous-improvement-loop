...
| 2026-04-23T21:11:53Z | TASK-192 | idea | pm | 为 a-plan 增加多任务规划模式，一次生成 N 个任务并排入队列 | pass: --count 参数已在 cmd_plan 实现，验证 a-plan --count 2 生成 TASK-193/TASK-194 不同标题任务成功 | auto-complete-TASK-192 |
